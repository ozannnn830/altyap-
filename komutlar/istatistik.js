...
.setDescription(`${ client.user.username}`)
  ...
  .addField("Discord.js Sürümü ", `${Discord.version}`, true)  
   .addField(`Destek Sunucum`, `[Tıkla](https://discord.gg/t6fDZyPA5b)`, true)
  .addField(`Botu Davet Et`, `[Tıkla](https://discord.com/oauth2/authorize?client_id=774765565466116126&scope=bot&permissions=805314622)`, true)
